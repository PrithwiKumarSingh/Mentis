...
export default function Auth(){
  ...
  if(authenticated == true){
    ...
    return (
        <div
         className="h-screen w-screen flex items-center justify-center  dark:bg-linear-to-br from-violet-950/90 via-[#070b29] to-[#121536] p-10 min-h-screen bg-cover bg-center bg-no-repeat">
            <motion.div 
                initial={{ opacity: 0, y: -80 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
                 className="flex flex-col  bg-linear-to-br from-violet-950/90 via-[#1c1f3f] to-[#080914] border border-white/50 items-center shadow-2xl  p-4 rounded-xl">
